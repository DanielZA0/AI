...
from sklearn import model_selection
 ...
 # segmentación de datos (training & testing)
...
# b)Calculo del centro de cada clase
u_a = data_2d_a.mean(axis = 1)
u_b = data_2d_b.mean(axis = 1)

# C)Calculo de la matriz de covarianza
...
x_a = np.array(data_2d_a[0])
y_a = np.array(data_2d_a[1])
